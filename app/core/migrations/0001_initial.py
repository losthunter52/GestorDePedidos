    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(blank=True, choices=[('Alimento Não Perecível', 'Alimento Não Perecível'), ('Remédio', 'Remédio'), ('Protetor Solar', 'Protetor Solar')], max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Pedido',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pedidos', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.pedido')),
            ],
        ),
    ]
